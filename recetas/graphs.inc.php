...
/*
 +-------------------------------------------------------------------+
 |                   H T M L - G R A P H S   (v2.7)                  |
 |                                                                   |
 | Copyright Gerd Tentler               info@gerd-tentler.de         |
 | Created: Sep. 17, 2002               Last modified: Dec. 3, 2004  |
 +-------------------------------------------------------------------+
...
// Configuration
//----------------------------------------------------------------------------------------------------
    var $type = 'hBar';                       // graph type: "hBar", "vBar" or "pBar"
    ...
    var $barColor;                            // bar color: string with comma-separated values or array
